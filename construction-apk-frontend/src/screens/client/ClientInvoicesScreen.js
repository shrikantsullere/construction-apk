...
const ClientInvoicesScreen = () => {
    return (
        <View style={styles.screen}>
            ...
            <WorkerHeader title="Financial Control" hideSearch />

            <View style={styles.emptyContainer}>
                <MaterialCommunityIcons name="receipt" size={80} color="#E2E8F0" />
                <Text style={styles.emptyTitle}>Project Invoices</Text>
