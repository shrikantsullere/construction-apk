...
const ClientRFIScreen = () => {
    return (
        <View style={styles.screen}>
            <StatusBar barStyle="dark-content" />
            <WorkerHeader title="Support & RFI" hideSearch />

            <View style={styles.emptyContainer}>
                <MaterialCommunityIcons name="help-box" size={80} color="#E2E8F0" />
                <Text style={styles.emptyTitle}>Support & RFI Center</Text>
